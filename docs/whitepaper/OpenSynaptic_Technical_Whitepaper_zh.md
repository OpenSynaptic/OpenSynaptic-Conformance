...
> 详见配套文档：[OpenSynaptic 测试与认证流程](OpenSynaptic_Certification_Process_zh.md)
> English version: [OpenSynaptic Testing and Certification Process](OpenSynaptic_Certification_Process.md)
